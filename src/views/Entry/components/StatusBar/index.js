...
//   getRangeJobSchedule
// } from 'utils/api';
import { fakeThisWeekJobScheduleReq } from './fakeDetails';
...
export default function StatusBar() {
  ...
  const { userInfo, asyncIsFileExist } = useContext(GlobalContext);
  ...
  */
  const initData = async () => {
    try {
      ...
      const thisWeekJobScheduleReq = [...fakeThisWeekJobScheduleReq]

      if(thisWeekJobScheduleReq && !isEmpty(thisWeekJobScheduleReq)){
        // console.log('thisWeekJobScheduleReq', thisWeekJobScheduleReq)
