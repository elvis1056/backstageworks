...
import { fakeCpu } from './fakeCpu';
import { fakeMemory } from './fakeMemory';
import { fakeMemoryTotal } from './fakeMemoryTotal';
  ...
  */
  const initData = async () => {
    ...
    try {
      ...
      // });
      const totalMemoryReq = { ...fakeMemoryTotal }
